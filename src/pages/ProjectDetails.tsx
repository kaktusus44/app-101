import { BarChart3, BookOpen, CalendarDays, ChevronRight, CircleDollarSign, FileText, Images, List, MapPin, Maximize, Pencil, Table2, Trash2, UserRound, Users } from 'lucide-react'
...
export function ProjectDetails() {
  const { projectId = '' } = useParams(); const navigate = useNavigate(); const { user } = useAuth(); const { projects,deleteProject } = useProjects(); const { counterparties } = useCounterparties()
